...
import (
	...
	"github.com/charliearnerstal/cordyceps/ds1/internal/background"
	"github.com/charliearnerstal/cordyceps/ds1/internal/commands"
	"github.com/charliearnerstal/cordyceps/ds1/internal/config"
	"github.com/charliearnerstal/cordyceps/ds1/internal/instance"
	"github.com/charliearnerstal/cordyceps/ds1/internal/protocol"
	"github.com/charliearnerstal/cordyceps/ds1/internal/startup"
...
func parseAgentOptions() agentOptions {
	...
	flag.StringVar(&opts.deviceID, "device-id", "", "Device ID (e.g. ds1)")
	...
	flag.BoolVar(&opts.installService, "install", false, "Install ds1 as an automatic Windows service")
	flag.BoolVar(&opts.uninstallSvc, "uninstall", false, "Uninstall the ds1 Windows service")
...
func runStandaloneAgent(opts agentOptions) error {
	...
	if executableResolved {
		if installed, err := installAndRelaunchIfNeeded(executablePath, os.Args[1:], opts.foreground, opts.runAgent, opts.enrollOnly); err != nil {
	...
	return runAgentHost(ctx, opts, executablePath, executableResolved, true)
}

func runAgentHost(ctx context.Context, opts agentOptions, executablePath string, executableResolved bool, allowStartup bool) error {
	...
	superviseAgent(ctx, cfgPath, opts.serverURL, opts.deviceID, opts.displayName, opts.bootstrapToken, opts.effectiveVersion(), opts.versionExplicit, executablePath, ensureStartup)
	return nil
}
